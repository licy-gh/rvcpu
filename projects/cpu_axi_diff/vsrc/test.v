...
module ysyx_219999_id_stage(
    ...
    assign uart_ena = (id_inst == 32'h0000007b || id_pc_i == 64'h80000054)   ?   `YSYX219999_TRUE_V :   `YSYX219999_FALSE_V;
    assign uart_data_out = (id_inst == 32'h0000007b)    ?   rd1[ 7: 0] : 8'b0;
...
module ysyx_219999_if_stage(
    ...
    reg hs_ena;
    always@(posedge cpu_clk_50M) begin
        if(flush == `YSYX219999_TRUE_V) begin
...
module ysyx_219999(
    ...
    assign  io_uart_out_valid = (core_uart_ena == `YSYX219999_TRUE_V)  ?  `YSYX219999_TRUE_V : `YSYX219999_FALSE_V;
    assign  io_uart_out_ch    = (core_uart_ena == `YSYX219999_TRUE_V)  ?   core_uart_out  : 8'b0;
